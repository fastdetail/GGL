...
function changeHeight5() {
	...
	if(windowWidth < 768) {
	//창 가로 크기가 500 미만일 경우
		document.getElementById('section_height').style.height = "1930px"
		document.getElementById('section_background').style.height = "1930px"
		document.getElementById('tabs-5').style.height = "200px"
	} else {
	//창 가로 크기가 500보다 클 경우
	document.getElementById('section_height').style.height = "4280px"
	document.getElementById('section_background').style.height = "4280px"
...
function changeHeight9() {
	...
	if(windowWidth < 768) {
	//창 가로 크기가 500 미만일 경우
		document.getElementById('section_height').style.height = "1430px"
		document.getElementById('section_background').style.height = "1430px"
		document.getElementById('tabs-9').style.height = "100px"
	} else {
	//창 가로 크기가 500보다 클 경우
		document.getElementById('section_height').style.height = "1390px"
		document.getElementById('section_background').style.height = "1390px"
...
function changeHeight13() {
	...
	if(windowWidth < 768) {
	//창 가로 크기가 500 미만일 경우
		document.getElementById('section_height').style.height = "1410px"
		document.getElementById('section_background').style.height = "1410px"
...
function changeHeight14() {
	...
	if(windowWidth < 768) {
	//창 가로 크기가 500 미만일 경우
		document.getElementById('section_height').style.height = "1250px"
		document.getElementById('section_background').style.height = "1250px"
...
function changeHeight17() {
	...
	if(windowWidth < 768) {
	//창 가로 크기가 500 미만일 경우
		document.getElementById('section_height').style.height = "860px"
		document.getElementById('section_background').style.height = "860px"
		document.getElementById('tabs-14').style.height = "200px"
	} else {
	//창 가로 크기가 500보다 클 경우
		document.getElementById('section_height').style.height = "2440px"
		document.getElementById('section_background').style.height = "2440px"
		document.getElementById('tabs-14').style.height = "470px"
	}
	$(window).on('resize',function(){
		var win = $(this);
